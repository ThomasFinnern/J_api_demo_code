...
use Bluebox\Component\Secondhand\Administrator\Service\HTML\AdministratorService;
use Bluebox\Component\Secondhand\Administrator\Service\HTML\Icon;
	...
	TagServiceInterface
{
	...
	{
		$this->getRegistry()->register('secondhandadministrator', new AdministratorService);
        $this->getRegistry()->register('secondhandicon', new Icon($container->get(SiteApplication::class)));
	}
	...
	public function getContexts(): array
	{
		...
		$contexts = array(
			'com_secondhand.book'    => Text::_('COM_SECONDHAND'),
            'com_secondhand.categories' => Text::_('JCATEGORY')
		);
	...
	{
		return ($section === 'category' ? 'categories' : 'secondhand_books');
	}
