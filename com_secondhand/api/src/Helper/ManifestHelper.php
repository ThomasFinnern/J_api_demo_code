 ...
 * @author         Secondhand Team <team2@Secondhand.org>
...
class ManifestHelper
{
	 ...
	 * @since   4.1.0
	 */
	public static function getDbManifestJson($extension = 'com_secondhand'): null|string
	{
		$manifest = null;
	 ...
	 * @since   4.1.0
	 */
	public static function getDbManifest($extension = 'com_secondhand'): null|array
	{
		$manifest = null;
	 ...
	 * @since   4.1.0
	 */
	public static function saveDbManifestJson(string $manifestJson, $extension = 'com_Secondhand'): null|string
	{
		$isSaved = false;
	 ...
	 * @since version
	 */
	public static function saveDbManifest($oManifest, $extension = 'com_Secondhand')
	{
		$isSaved = false;
...
//			. ' WHERE element = ' . $db->quote('com_Secondhand')
//		)->execute();
//	}
//
